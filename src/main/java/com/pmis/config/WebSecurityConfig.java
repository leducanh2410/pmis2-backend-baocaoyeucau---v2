...
import com.pmis.security.jwt.AuthEntryPointJwt;
import com.pmis.security.jwt.AuthTokenFilter;
...
public class WebSecurityConfig {
	...
	@Value("${app.splituseridandpass}")
	private String splituseridandpass;
	
	@Value("${app.smartevnapi}")
	private String smartevnapi;
